        ...
        <div>
            <footer className="footer footer-center p-10 bg-gray-200 text-base-content rounded">
                <div className="grid grid-flow-col gap-4 text-base">
                    <Link to='' className="link decoration-transparent">About us</Link>
                    <Link to='' className="link decoration-transparent">Contact</Link>
                    <Link to='' className="link decoration-transparent">Colleges</Link>
                    <Link to='' className="link decoration-transparent">Admission</Link>
                </div>
                <div>
                ...
                <div>
                    <p>Copyright © 2023 - All right reserved by Sanjoy Sarker</p>
                </div>
            </footer>
        </div>
    );
